...
const fetchAllCategories = async ()=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get('/categories', {
...
const fetchCategoryById = async (id)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(`/categories/${id}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
const createCategory = async (data)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post('/categories', data, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
const updateCategory = async (id, data)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].put(`/categories/${id}`, data, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
const deleteCategory = async (id)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/categories/${id}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
"[project]/src/app/dashboard/transaction/edit/[id]/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditTransactionPage() {
    ...
    const loadTransaction = async ()=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$transaction$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fetchTransactionById"])(Number(params?.id));
            const tx = res.data;
            setInitialData({
                type: tx.type,
    ...
    const handleSubmit = async (form)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$transaction$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["editTransaction"])(Number(params?.id), {
                ...form
            });
            setModal({
                type: "success",
...
//# sourceMappingURL=src_12daf426._.js.map