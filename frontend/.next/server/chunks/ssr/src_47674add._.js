...
function ProfilePage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            const update = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateUser"])(form.id, {
                name: form.name,
                email: form.email,
