...
"[project]/src/utils/convertNumberRupiah.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const fetchAllCategories = async ()=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get('/categories', {
...
const fetchCategoryById = async (id)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`/categories/${id}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
const createCategory = async (data)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].post('/categories', data, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$handleApiError$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["handleApiError"])(error, "failed to create categories");
    }
};
const updateCategory = async (id, data)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`/categories/${id}`, data, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
const deleteCategory = async (id)=>{
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].delete(`/categories/${id}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$getTokenHeader$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])()
        });
        return res.data;
    } catch (error) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$convertNumberRupiah$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/convertNumberRupiah.ts [app-client] (ecmascript)");
...
const TransactionForm = ({ initialData, onSubmit })=>{
    ...
    const handleChange = (e)=>{
        ...
        if (name === "amount") {
            ...
            const formatted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$convertNumberRupiah$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"])(clean);
            setForm((prev)=>({
                    ...prev,
                    amount: formatted
                }));
...
_s(TransactionForm, "tGLTYNaaoiVQdQqJiuGiRFHbSaw=");
_c = TransactionForm;
...
"[project]/src/app/dashboard/transaction/edit/[id]/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function EditTransactionPage() {
    ...
    const loadTransaction = async ()=>{
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$transaction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchTransactionById"])(Number(params?.id));
            const tx = res.data;
            setInitialData({
                type: tx.type,
    ...
    const handleSubmit = async (form)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$transaction$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["editTransaction"])(Number(params?.id), {
                ...form
            });
            setModal({
                type: "success",
    ...
    if (loading) return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ui$2f$LoadingSpinnerScreen$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {}, void 0, false, {
        fileName: "[project]/src/app/dashboard/transaction/edit/[id]/page.tsx",
        lineNumber: 70,
        columnNumber: 23
    }, this);
    console.log({
...
_s(EditTransactionPage, "zRVZms0jdcCslCNNIOkfOOV5HcA=", false, function() {
    return [
...
//# sourceMappingURL=src_f00b3386._.js.map